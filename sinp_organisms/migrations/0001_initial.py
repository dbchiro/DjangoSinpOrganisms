    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('extra_data', models.JSONField(blank=True, null=True, verbose_name='Additional datas')),
                ('action_scope', models.ForeignKey(help_text="Périmètre d'action de l'organisme (Européen, national, Supra-régional, Régional, Inconnu)", limit_choices_to={'type': 'action_scope'}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_action_scope', to='sinp_nomenclatures.item', verbose_name="Périmètre d'action")),
                ...
                ('geographic_area', models.ForeignKey(blank=True, help_text="Zone d'action géographique de l'organisme", limit_choices_to={'type': 'geographic_area'}, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_geographic_area', to='sinp_nomenclatures.item', verbose_name='Zone géographique')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member_level', models.ForeignKey(limit_choices_to={'type': 'member_level'}, on_delete=django.db.models.deletion.CASCADE, related_name='member_level', to='sinp_nomenclatures.item', verbose_name='Niveau du membre')),
                ('organism', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sinp_organisms.organism', verbose_name='Organisme')),
        ...
        migrations.AddField(
            model_name='organism',
            name='members',
            field=models.ManyToManyField(blank=True, related_name='organism_member', through='sinp_organisms.OrganismMember', to=settings.AUTH_USER_MODEL, verbose_name='Membres'),
        ),
        migrations.AddField(
            model_name='organism',
            name='status',
            field=models.ForeignKey(help_text="Permet d'indiquer si l'organisme est public ou privé", limit_choices_to={'type': 'organism_status'}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_status', to='sinp_nomenclatures.item', verbose_name='Statut'),
        ),
        migrations.AddField(
            model_name='organism',
            name='type',
            field=models.ForeignKey(limit_choices_to={'type': 'organism_type'}, on_delete=django.db.models.deletion.DO_NOTHING, related_name='organism_type', to='sinp_nomenclatures.item', verbose_name="Type d'organisme"),
        ),
        migrations.AddField(
            model_name='organism',
            name='updated_by',
